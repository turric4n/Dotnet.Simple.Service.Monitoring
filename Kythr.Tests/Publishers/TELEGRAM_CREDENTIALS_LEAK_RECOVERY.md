...
```powershell
# 1. Create a backup
cd C:\git\Dotnet.Kythr\..
git clone --mirror C:\git\Dotnet.Kythr dotnet-monitoring-backup.git
...
java -jar bfg-1.14.0.jar --replace-text passwords.txt C:\git\Dotnet.Kythr
...
# Create backup
cd C:\git\Dotnet.Kythr\..
git clone C:\git\Dotnet.Kythr dotnet-monitoring-backup
...
cd C:\git\Dotnet.Kythr\Kythr.Tests
...
1. Go to: `https://github.com/turric4n/Dotnet.Kythr`
...
- `https://github.com/turric4n/Dotnet.Kythr/security`
