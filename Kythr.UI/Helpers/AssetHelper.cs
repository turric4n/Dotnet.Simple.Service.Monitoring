        ...
        private static void LoadManifestIfNeeded()
        {
            ...
            lock (ManifestLock)
            {
                ...
                try
                {
                    ...
                    var assembly = typeof(Kythr.UI.Models.IndexModel).Assembly;
                    var embeddedProvider = new EmbeddedFileProvider(assembly, "Kythr.UI.wwwroot");
