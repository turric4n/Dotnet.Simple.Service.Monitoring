...
namespace Simple.Service.Monitoring.Library.Monitoring.Implementations.Publishers.Console
{
    public class ConsoleAlertingPublisher : PublisherBase
    {
        ...
        private void WriteToConsole(KeyValuePair<string, HealthReportEntry> entry)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Failed to write console alert: {ex.Message}");
            }
        }
