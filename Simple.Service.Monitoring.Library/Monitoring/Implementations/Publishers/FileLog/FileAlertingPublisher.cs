...
namespace Simple.Service.Monitoring.Library.Monitoring.Implementations.Publishers.FileLog
{
    public class FileAlertingPublisher : PublisherBase
    {
        ...
        private void WriteToFile(KeyValuePair<string, HealthReportEntry> entry)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Failed to write file alert: {ex.Message}");
            }
        }
